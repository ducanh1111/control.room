                                ...
                                <div class="card-header">
                                    ...
                                    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" style="float: right">
                                        <label style="float: left; width:20% ">Condition
                                            ...
                                            <option ${(requestScope.condition eq "availiable")?"selected=\"selected\"":""} value="availiable">Available</option>
                                            <option ${(requestScope.condition eq "unavaliable")?"selected=\"selected\"":""} value="unavaliable">Unavailable</option>
                                        </select></label>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <c:forEach items="${requestScope.rooms}" var="r">
                                            <tr>
                                                <td>${r.rname}</td>
                                                <td>${(r.condition)?"Available":"Unavailable"}</td>

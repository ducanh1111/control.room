                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td><input placeholder="Enter Student Name" type="text" name="name" required></td>
                                                    <td><input type="radio" checked="checked" name="gender" value="male">M<br>
                                                        <input type="radio" name="gender" value="female">F
                                                    </td>
                                                    <td><input type="date" name="dob" required></td>
                                                    <td><input placeholder="Enter Student Phone" type="text" name="phonenumber" required></td>
                                                    <td><input placeholder="Enter Student Cardnumber" type="text" name="cardnumber" required></td>
                                                    <td><input placeholder="Enter Student Address" type="text" name="address" required></td>
                                                </tr>
                                            </tbody>
                                            <tfoot>
